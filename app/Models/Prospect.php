...
class Prospect extends CoreModel{

   protected $id;
   private $numero_prospect;
   private $type_de_prospect;
   ...
   /**
    * Get the value of numero_prospect
    */
   public function getNumeroProspect()
   {
      return $this->numero_prospect;
   }

   /**
    * Set the value of numero_prospect
    */
   public function setNumeroProspect($numero_prospect): self
   {
      $this->numero_prospect = $numero_prospect;

      return $this;
   }

   /**
    * Get the value of type_de_prospect
    */
   public function getTypeDeProspect()
   {
      return $this->type_de_prospect;
   }

   /**
    * Set the value of type_de_prospect
    */
   public function setTypeDeProspect($type_de_prospect): self
   {
